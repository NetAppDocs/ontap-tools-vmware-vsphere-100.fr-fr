...
Pour plus d'informations, reportez-vous à la section https://library.netapp.com/ecm/ecm_download_file/ECMLP2886542["Notes de version des outils ONTAP pour VMware vSphere 10.0"^].
